...
import 'package:weather_app/controller/params.dart';
...
Future main() async {
  ...
  Get.put(ParamsController(), permanent: true);
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      localeResolutionCallback: (locale, supportedLocales) {
        ...
        // Si la locale n'est pas supportée, utiliser l'anglais
...
class _MainState extends State<Main> {
  ...
  _loadRefreshKey() {
    ...
    paramsController.refreshIndicatorKey = GlobalKey<RefreshIndicatorState>();
  }
